...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { description: @map.description, image_path: @map.image_path, name: @map.name }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { description: @map.description, image_path: @map.image_path, name: @map.name }
    assert_redirected_to map_path(assigns(:map))
  end
